---
layout: post
title:  "cmusphinx pocketSphinx cross compile"
author: Willen
categories: [ 语音识别 ]
tags: [ cmuphinx ]
comments: false
...
# cmusphinx pocketSphinx cross compile

Host compile dependency:
...
Optional Packages:
  ...
  --with-python           Enable Python extension, built with swig, enabled by
                          default
